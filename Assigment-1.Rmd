...
In general for both networks, we see that the managers in the lowest hierarchical levels (the squares), seems to have the most negative degree difference (indicated by the red color). This tells us that they ask more questions that they are asked, which indicates that they go to their superior for help and advice, and they themselves are not asked for advice. For the friendship network this tells us that people often tend to see their superiors as friends, but the superiors does not see the managers below the in the hierarchy as friends in the same way. 
